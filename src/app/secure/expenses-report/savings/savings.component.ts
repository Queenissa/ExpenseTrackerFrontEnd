...
export class SavingsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.http.get('http://localhost:8000/savings',{
      headers :{
    ...
    viewUpdateExpenseForm(el:any){
      ...
      this.router.navigate(['secure/expenses-report/savings/savings-update/'],
    ...
    delete(el : any){
      ...
      if (prompt == true) {
        ...
        this.router.navigate(['secure/expenses-report/savings'])
    }
  }
